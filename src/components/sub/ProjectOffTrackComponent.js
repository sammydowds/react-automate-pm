      ...
      <span>
        <p style={{fontweight: 'superbold', fontSize: "12px"}}>
          <span>
            ...
            &nbsp; 
            <a className="project-link" onClick={() => {handleClicked(project.id);}}>
              {project.name}
            </a>
          </span>
        </p>  
        ...
        <Col>
          <Card className="mt-3 card-border">
            <CardBody>
              ...
              <CardText className="font-weight-bold text-left pl-2">{renderProj(offtrack_projects, props.handleProjectClicked)}</CardText>
            </CardBody>
          </Card>
        </Col>
      </Row>
